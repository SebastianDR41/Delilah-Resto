...
Alumno: Sebastian Alejandro De Rosa

Email: derosa127@alumnos.iua.edu.ar
...
3.   El siguiente paso es configurar la base de datos para conectarlo con nuestro proyecto. Para eso en la li­nea numero 12 del archivo serverdelilah, reemplaza en ("mysql://root:@localhost:3306/delilah") el segmento "root:" por su usuario y contraseña de la base de datos de la siguiente manera --> usuario:contraseña

4.   Ahora solo falta ejecutar el archivo y ya esta listo para usar la api desde el puerto 3000 de su computadora, para empezar a usar la api puede crear un nuevo usuario desde el endpoint post usuarios y para probar las funcionalidades de administrador, aca le dejo el usuario y contraseña necesario para ello:
